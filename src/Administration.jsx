...
function Row(props) {
  const { row, isItemSelected, labelId, handleClick, setRows } = props;
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell align="center" onClick={() => console.log("edit")}>
          <EditRow setRows={setRows} data={row} />
        </TableCell>
      </TableRow>
      <TableRow>
...
export default function Administration() {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <Box
        sx={{ display: "flex", justifyContent: "flex-start", paddingX: "2rem" }}
      >
